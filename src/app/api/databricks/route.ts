...
export async function GET() {
  try {
    ...
    let budgetVarProcs = 0, budgetFixedProcs = 521;
    ...
    const mtdPerformance = {
      ...
      procedures: {
        ...
        budget_mtd:        Math.round(budVarProcsMtd + budFixedProcsMtd) || null,
        budget_eom:        budgetTotalProcsEom || null,
        okr_mtd:           okrTotalProcsMtd || null,
        okr_eom:           okrTotalProcs || null,
        var_vs_py_mtd:     pyTotalProcs ? actTotalProcs - Math.round(pyTotalProcs * scaleDownFactor) : null,
        var_vs_py_eom:     pyTotalProcs ? actTotalProcsEom - pyTotalProcs : null,
        var_vs_budget_mtd: budgetTotalProcs ? actTotalProcs - Math.round(budVarProcsMtd + budFixedProcsMtd) : null,
        ...
        pct_of_py_mtd:     pyTotalProcs ? parseFloat((actTotalProcs / Math.round(pyTotalProcs * scaleDownFactor)).toFixed(3)) : null,
        pct_of_py_eom:     pyTotalProcs ? parseFloat((actTotalProcsEom / pyTotalProcs).toFixed(3)) : null,
        pct_of_budget_mtd: budgetTotalProcs ? parseFloat((actTotalProcs / Math.round(budVarProcsMtd + budFixedProcsMtd)).toFixed(3)) : null,
